                                ...
                                <tbody>
                                    @foreach ($barang as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->stok }}</td>
                                            <form action="/cekstok" method="post">
                                                <td>
                                                    @csrf
                                                    <input name="IDbarang" type="hidden" value="{{ $data->IDbarang }}">
                                                    <input name="stokSistem" type="hidden" value="{{ $data->stok }}">
                                                    <input name="stokFisik" type="number" min="1">
                                                </td>
                                                <td>
